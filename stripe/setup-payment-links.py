...
else and it does every store listed in STORES. --dry-run shows what it would create and changes
...
def main():
    ...
    ap.add_argument("--store", action="append", choices=sorted(STORES),
                    help="limit to one store; repeatable. Default: every store in STORES.")
