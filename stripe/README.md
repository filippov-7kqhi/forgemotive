# Payments and the Worker: ForgeMotive

## How forgemotive.shop takes payment
...
`GET /stats` returns them, stored in the KV namespace `forgemotive-EVENTS`.

- Worker: `https://forgemotive-collector.stellapark1141.workers.dev`
...
needed: without it the script refuses a key whose account name is not ForgeMotive.
...
& {
  ...
  Set-Location "C:\Users\Hp\uk-stores\forgemotive\stripe"
...
- delete the KV namespace `forgemotive-EVENTS`. It holds the dashboard's data.
